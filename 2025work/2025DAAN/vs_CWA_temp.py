...
## === 路徑設定 ===
cwa_folder_path = r"/home/steven/python_data/2025DAAN_park/20250815-0818CWA"
base_folder_path = r"/home/steven/python_data/2025DAAN_park/20250815-0818觀測坪"
...
def compare_daily_all_tags():
    ...
    for cwa_file_path_str in cwa_files_list:
        ...
        save_path_str = rf"{output_folder_path}\result\{day_str}_ALL_vs_CWA_raw2s_to_1min.png"
