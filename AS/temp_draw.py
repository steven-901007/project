...
data_folder = rf"{data_top_path}\20250704T045315Z-1-001\2024-05-09_avg10min"  
target_file = "2024-05-01_lv2.nc"  
...
ts = ds['Ts'].values  # 地面溫度，單位通常為 °C 或 K，請自行確認
rain_flag = ds['FLG_RAIN'].values  

## === 畫圖 ===
fig, ax = plt.subplots(figsize=(12, 5))
ax.plot(time, ts, 'orange', label='Surface Temperature')
...
## 格式設定
ax.set_ylabel('Surface Temperature [°K]')  # 若單位是K，這邊請自行改
ax.grid()
ax.legend()
ax.set_title(day)
