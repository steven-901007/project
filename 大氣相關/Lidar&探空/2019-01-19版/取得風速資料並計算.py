...
for file in files:
        ...
        for f in result:
            try:
                ...
                # f = "C:/Users/steve/Desktop/python/松山剖風儀/2019-03-13/wind_reconstruction_data/00-00\WLS100s-46_WindReconstructionData_2019-01-19_00-00-20_DBS_74_25m.csv"
                ...
                time = f[123:131]
                wbu.save('C:/Users/steve/Desktop/python/松山剖風儀資料/2019-01-19/u/'+time+'.xlsx') #第1行高度 = 100m
                wbv.save('C:/Users/steve/Desktop/python/松山剖風儀資料/2019-01-19/v/'+time+'.xlsx') #第1行高度 = 100m
                print(time)
            except:
                print(f)
