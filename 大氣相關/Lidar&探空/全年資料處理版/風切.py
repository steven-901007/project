...
# day = "2019-12-06"
        ...
        wb10 = load_workbook("C:/Users/steve/Desktop/python相關資料/need data information/" + locate + "/" + year + "/10min/"+day+".xlsx")
        wsu = wb10['U']
        wsv = wb10['V']
        ...
        wb.save("C:/Users/steve/Desktop/python相關資料/need data information/" + locate + "/" + year + "/windcut/"+day+".xlsx")
        print(day)
