...
for file in files:
    ...
    #先將所需要的sheet都建立好
    wb_old = load_workbook("C:/Users/steve/Desktop/python相關資料/need data information/"+locate+'/'+year+"/need_information_read/"+day+'.xlsx')
    ws0 = wb_old['0']
    ws1 = wb_old['1']   
    ws2 = wb_old['2']
    ws3 = wb_old['3']
    ...
    if chack == []:
        ...
        print(chack)
    wb_new.save("C:/Users/steve/Desktop/python相關資料/need data information/"+locate+'/'+year+"/need_information_set/"+day+'.xlsx')
    wb_new.close()
    print(day)
endTime = T.time()
