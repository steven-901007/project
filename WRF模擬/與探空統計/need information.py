...
import glob
files = glob.glob('C:/Users/steve/Desktop/python相關資料/觀測rowdata/NAS_B_obs/TW_SOUNDING/2019/46692/*')
for file in files:
    m = file[77:]
    # print(m)

    files = glob.glob('C:/Users/steve/Desktop/python相關資料/觀測rowdata/NAS_B_obs/TW_SOUNDING/2019/46692/'+m+'/*')
    for file in files:
        try:
            day  =file[86:90] + '-' + file[90:92] + '-' + file[92:94] + '_' + file[94:96]
    # print(day)
    # print(file)

    # day = '2019-01-06'

    # file = "C:/Users/steve/Desktop/python相關資料/觀測rowdata/NAS_B_obs/TW_SOUNDING/2019/46692/01/46692-"+day[0:4]+day[5:7]+day[8:10]+"00.shr.txt"
            hight = []
            v = []
            d = []
            time = []
